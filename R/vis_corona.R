...
trends_combined <- read_rds(file.path("data", "trends_2020_combined.rds"))
...
ggsave(file.path("plots", "corona_gtrends_de_2020_dark.png"), type = "cairo", dpi = 200, width = 6, height = 8)
